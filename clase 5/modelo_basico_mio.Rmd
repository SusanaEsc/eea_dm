...
#
#   diff <- (model1(mod, data) - data$y )
#sqrt( sum(diff^2)/nrow(data)) 
...
aca abajo se ve la superficie de ...donde está el minimo, en el valle del medio, en rojo los diez mejores modelos
